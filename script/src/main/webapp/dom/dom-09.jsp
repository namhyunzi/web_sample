...
<script type="text/javascript">
	...
	function checkForm(event) {
		...
		// 3. 입력필드 값을 체크해서 경고창을 표시하거나, 폼입력값을 서버로 제출시킨다.
		if (keyword == "") {
			
			// 4. 경고메세지 엘리먼트를 선택한다.
			let div = document.getElementById("div-keyword-alert");
			
			// 5. class 속성값에서 "d-none"를 삭제한다.
			let list = div.classList;
			list.remove("d-none");
			
			// 6. submit 이벤트가 발생했을 때 form 입력값이 서버로 제출되는 것을 막는다.
