...
--%>
		<form>
			<div class="form-group">
				<label class="from-label">카테고리</label>
			...
			<div class="form-group">
				<label class='form-lable'>닉네임</label>
				<input type="text" class="form-control" name="nickname" value="멋쟁이" />
			</div>
			<div class="form-group">
				<label class='form-lable'>메모</label>
...
<script type="text/javascript">
	...
	/*
		폼 입력양식(input, select, textarea)의 값 조회하기
			let x = element.value;
	        * x에 해당 엘리먼트의 값이 대입된다.
	        
	    폼 입력양식(input, select, textarea)의 값 변경하기
	    	element.value = '값';
	*/
	...
	let e15 = document.querySelector("#status-301");
	e15.checked = true;
	
	// radio버튼 중에서 체크된 라디오버튼의 값을 조회하기
	let e16 = document.querySelector("input[name=status]:checked");
	let value6 = e16.value;
	console.log(value6);
